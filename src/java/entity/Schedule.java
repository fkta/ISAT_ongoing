...
@NamedQueries({
    ...
    , @NamedQuery(name = "Schedule.findByShareSchedule", query = "SELECT s FROM Schedule s WHERE s.scheduleId = :scheduleId and cast(:date as date) between cast(s.sDate as date) and cast(s.eDate as date)")})
